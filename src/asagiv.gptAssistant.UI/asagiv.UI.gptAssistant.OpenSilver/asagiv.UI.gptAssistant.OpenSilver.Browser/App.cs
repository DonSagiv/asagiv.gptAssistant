...
namespace asagiv.UI.gptAssistant.OpenSilver.Browser
{
    public class App : ComponentBase
    {
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(1, "AppAssembly", RuntimeHelpers.TypeCheck(typeof(Program).Assembly));

            builder.AddAttribute(2, "PreferExactMatches", RuntimeHelpers.TypeCheck(true));

            builder.AddAttribute(3, "Found", (RenderFragment<RouteData>)(routeData => builder2 =>
            {
                builder2.OpenComponent<RouteView>(4);
                builder2.AddAttribute(5, "RouteData", RuntimeHelpers.TypeCheck(routeData));
